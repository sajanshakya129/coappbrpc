...
const ::google::protobuf::uint32 TableStruct_rpc_5fping_2eproto::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::pbrpc::api::PingRequest, _has_bits_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::pbrpc::api::PingRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::pbrpc::api::PingRequest, message_),
  0,
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::pbrpc::api::PingResponse, _has_bits_),
...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 6, sizeof(::pbrpc::api::PingRequest)},
  { 7, 13, sizeof(::pbrpc::api::PingResponse)},
};
...
::google::protobuf::internal::DescriptorTable descriptor_table_rpc_5fping_2eproto = {
  ...
  "\n\016rpc_ping.proto\022\tpbrpc.api\"\036\n\013PingReque"
  "st\022\017\n\007message\030\001 \002(\t\"\036\n\014PingResponse\022\016\n\006r"
  "esult\030\001 \002(\t2F\n\013PingService\0227\n\004Ping\022\026.pbr"
  "pc.api.PingRequest\032\027.pbrpc.api.PingRespo"
  "nseB\003\200\001\001"
,
  "rpc_ping.proto", &assign_descriptors_table_rpc_5fping_2eproto, 168,
};
...
class PingRequest::HasBitSetters {
 public:
  static void set_has_message(PingRequest* msg) {
    msg->_has_bits_[0] |= 0x00000001u;
  }
};

#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int PingRequest::kMessageFieldNumber;
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 1: {
        ...
        if (!ptr) goto error;
        ctx->extra_parse_data().SetFieldName("pbrpc.api.PingRequest.message");
...
class PingResponse::HasBitSetters {
 public:
  static void set_has_result(PingResponse* msg) {
    msg->_has_bits_[0] |= 0x00000001u;
  }
};
